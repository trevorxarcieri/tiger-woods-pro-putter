namespace Unity.Tutorials.Core.Editor
{
    internal class LocalizationKeys
    {
        ...
        internal const string k_SettingsShowTutorialsWindowClosedDialog = "SettingsShowTutorialsWindowClosedDialog";
        ...
        //Tutorials Window closed dialog
        internal const string k_WindowClosedDialogTitle = "WindowClosedDialogTitle";
        internal const string k_WindowClosedDialogMessage = "WindowClosedDialogMessage";
        internal const string k_WindowClosedDialogButtonOk = "WindowClosedDialogButtonOk";

        //Table Of Content View
        internal const string k_TOCLabelTitle = "TOCLabelTitle";
        internal const string k_TOCLabelSubtitle = "TOCLabelSubtitle";
        internal const string k_TOCLabelCompleted = "TOCLabelCompleted";
        internal const string k_TOCButtonBackTooltip = "TOCButtonBackTooltip";
        ...
        //Authoring toolbar
        internal const string k_AuthoringButtonSelectCategory = "AuthoringButtonSelectCategory";
        internal const string k_AuthoringButtonSelectTutorial = "AuthoringButtonSelectTutorial";
        internal const string k_AuthoringButtonSelectPage = "AuthoringButtonSelectPage";
        internal const string k_AuthoringButtonSkipToEnd = "AuthoringButtonSkipToEnd";
        internal const string k_AuthoringButtonAutocompletePage = "AuthoringButtonAutocompletePage";

        //Welcome / Closing Dialog
        internal const string k_IconPreviewMaskingTooltip = "IconPreviewMaskingTooltip";

        //Custom Inspectors
        internal const string k_TutorialPageLabelTitle = "TutorialPageLabelTitle";
        internal const string k_TutorialPageLabelEventStateWarning = "TutorialPageLabelEventStateWarning";
        ...
        internal const string k_TutorialWelcomePageButtonShowDialog = "TutorialWelcomePageButtonShowDialog";
        internal const string k_ButtonRunStartupCode = "ButtonRunStartupCode";
    }
}
